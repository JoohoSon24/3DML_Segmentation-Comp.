...
SOURCE_ROOT="${SOURCE_ROOT:-$REPO_DIR/../multiscan/dataset/object_instance_segmentation}"
MESH_PATH="${MESH_PATH:-$REPO_DIR/assets/sample.glb}"
OUTPUT_DIR="${OUTPUT_DIR:-$REPO_DIR/data/nubzuki_multiscan_trainval_npy_x2_revised}"
